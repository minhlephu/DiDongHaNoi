...
namespace DiDongHaNoi.Areas.Admin.Controllers
{
    ...
    public class AdminPostsController : Controller
    {
        ...
        public AdminPostsController(QlbanDienThoaiContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("PostId,Title,Scontents,Contents,Thumb,Published,IsNewFeed,IsHot,Alias,CreateDate,Author,AccountId,CatId,Tags,MetaDesc,MetaKey,Views")] Post post, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PostId,Title,Scontents,Contents,Thumb,Published,IsNewFeed,IsHot,Alias,CreateDate,Author,AccountId,CatId,Tags,MetaDesc,MetaKey,Views")] Post post)
        {
            if (id != post.PostId)
            {
                return NotFound();
