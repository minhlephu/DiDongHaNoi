...
namespace DiDongHaNoi.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AccountId,Phone,Email,Salt,Active,FullName,RoleId,LastLogin,CreateDate")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AccountId,Phone,Email,Salt,Active,FullName,RoleId,LastLogin,CreateDate")] Account account)
        {
